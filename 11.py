def LargestProductInGrid(n):
	...
	l1=['08','02','22','97','38','15','00','40','00','75','04','05','07','78','52','12','50','77','91','08']
	l2=['49','49','99','40','17','81','18','57','60','87','17','40','98','43','69','48','04','56','62','00']
	l3=['81','49','31','73','55','79','14','29','93','71','40','67','53','88','30','03','49','13','36','65']
	l4=['52','70','95','23','04','60','11','42','69','24','68','56','01','32','56','71','37','02','36','91']
	l5=['22','31','16','71','51','67','63','89','41','92','36','54','22','40','40','28','66','33','13','80']
	l6=['24','47','32','60','99','03','45','02','44','75','33','53','78','36','84','20','35','17','12','50']
	l7=['32','98','81','28','64','23','67','10','26','38','40','67','59','54','70','66','18','38','64','70']
	l8=['67','26','20','68','02','62','12','20','95','63','94','39','63','08','40','91','66','49','94','21']
	l9=['24','55','58','05','66','73','99','26','97','17','78','78','96','83','14','88','34','89','63','72']
	...
	grid=[l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16,l17,l18,l19,l20]
	for h in range(len(grid)):
		for w in range(len(grid)-n+1):
			a=grid[h]
			sss=int(a[w])*int(a[w+1])*int(a[w+2])*int(a[w+3])
			lst.append(sss)
			count1+=1
	for h in range(len(grid)-n+1):
		for w in range(len(grid)):
			...
			c=grid[h+2]
			d=grid[h+3]
			sss=int(a[w])*int(b[w])*int(c[w])*int(d[w])
			lst.append(sss)
			count2+=1
	for h in range(len(grid)-n+1):
		for w in range(len(grid)-n+1):
			...
			c=grid[h+2]
			d=grid[h+3]
			sss=int(a[w])*int(b[w+1])*int(c[w+2])*int(d[w+3])
			lst.append(sss)
			count3+=1
	for h in range(len(grid)-n+1):
		for w in range(n-1,len(grid)):
			a=grid[h]
			b=grid[h+1]
			c=grid[h+2]
			d=grid[h+3]
